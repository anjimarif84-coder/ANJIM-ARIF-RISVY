...
resource "aws_ecs_task_definition" "backend" {
  ...
  container_definitions = jsonencode([
    {
      name  = "backend"
      image = "${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.aws_region}.amazonaws.com/elearning-backend:latest"
...
resource "aws_ecs_task_definition" "frontend" {
  ...
  container_definitions = jsonencode([
    {
      name  = "frontend"
      image = "${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.aws_region}.amazonaws.com/elearning-frontend:latest"
...
resource "aws_appautoscaling_policy" "backend" {
  name               = "${local.name}-backend-scaling"
